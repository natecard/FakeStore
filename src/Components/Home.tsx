...
export default function Home() {
  return (
    <div>
      ...
      <div className=" font-base flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center">
          <div className="absolute inset-auto right-1/2 h-56 md:w-[30rem] bg-gradient-conic from-green-600 via-black to-transparent text-white [--conic-position:from_70deg_at_center_top]"></div>
          <div className="absolute inset-auto left-1/2 h-56 md:w-[30rem] bg-gradient-conic from-transparent via-black to-green-600 text-white [--conic-position:from_290deg_at_center_top]"></div>
          <div className="absolute top-1/2 h-48 w-full translate-y-12 bg-black blur-2xl"></div>
          <div className="absolute top-1/2 z-50 h-48 w-full bg-transparent opacity-10 backdrop-blur-md"></div>
          <div className="absolute inset-auto z-50 h-36 md:w-[28rem] -translate-y-1/2 rounded-full bg-green-300 opacity-50 blur-3xl"></div>
